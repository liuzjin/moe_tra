...
from .layers.multimodal_decoder import  BSpline_Decoder, Bezier_decoder, HierarchicalDecoder, MoE_QueryDecoder, Multi_Bezier_decoder, MultiModalIntentDecoder, MultiModalIntentDecoder2, MultimodalDecoder, QuerrySegmentDecoder, QueryBasedMoeDecoder, RefinementDecoder, Regress_refine, Regress_refine_v2, RegressionSegmentDecoder, RegressionSegmentDecoder2, SimpleSegmentalMoeDecoder
    ...
    def __init__(
        ...
        if moe:
            if moe_type == "cross":
                ...
                self.decoder = RegressionSegmentDecoder2(
                    embed_dim=embed_dim,
                    num_modes=modes,
                    future_len=future_len,
                    future_steps=future_steps,
